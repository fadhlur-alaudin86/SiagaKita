...
void main() {
  ...
  test(
    'saveSession persists token in secure storage and metadata in prefs',
    () async {
  ...
  test(
    'loadSession migrates legacy token from SharedPreferences to secure storage',
    () async {
  ...
  test('saveSession and getRefreshToken persist and update refresh tokens', () async {
    await SessionService.saveSession(
