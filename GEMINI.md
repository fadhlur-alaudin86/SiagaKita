...
- **Concise Plain-Text Commit Messages vs Rich Detailed PRs**:
  ...
  - **GitHub Pull Request Descriptions**: Place the comprehensive, detailed breakdown of changes, architectural rationale, component updates, and test verification matrices inside the Pull Request description, where rich GitHub Flavored Markdown (GFM) (headings, tables, links, code blocks) is fully supported.
- **Language Policy**:
